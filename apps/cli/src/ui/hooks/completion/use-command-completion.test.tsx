...
} from './use-command-completion.js';
import type { CommandContext } from '../../commands/types.js';
import type { Config } from '../../../config/config.js';
import { useTextBuffer } from '../input/use-text-buffer.js';
import type { Suggestion } from '../../components/input/suggestions-display.js';
import type { UseAtCompletionProps } from './use-at-completion.js';
import { useAtCompletion } from './use-at-completion.js';
import type { UseSlashCompletionProps } from './use-slash-completion.js';
import { useSlashCompletion } from './use-slash-completion.js';

vi.mock('./use-at-completion', () => ({
  useAtCompletion: vi.fn(),
}));

vi.mock('./use-slash-completion', () => ({
