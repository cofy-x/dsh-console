...
import { useShellHistory } from './use-shell-history.js';
...
vi.mock('@cofy-x/dsh-console-core', async (importOriginal) => {
  ...
  class Storage {
    static getGlobalSettingsPath(): string {
      return '/test/home/.dsh-console/settings.json';
    }
    getProjectTempDir(): string {
      return path.join('/test/home/', actual.DSH_CONSOLE_DIR, 'tmp', 'mocked_hash');
    }
    getHistoryFilePath(): string {
      return path.join(
        '/test/home/',
        actual.DSH_CONSOLE_DIR,
        'tmp',
        'mocked_hash',
        'shell_history',
      );
