...
describe('AskUserDialog', () => {
  ...
  describe.each([
    {
      ...
      expectedSubmit: { '0': { selected: ['OAuth 2.0'] } },
    },
    {
      name: 'Multi-select',
      questions: [
      ...
      expectedSubmit: { '0': { selected: ['TypeScript', 'ESLint'] } },
    },
    {
      name: 'Text Input',
      questions: [
      ...
      expectedSubmit: { '0': { selected: [], custom: 'test-app' } },
    },
  ...
  describe('Text type questions', () => {
    ...
    it('handles mixed text and choice questions', async () => {
      ...
      await waitFor(() => {
        expect(onSubmit).toHaveBeenCalledWith({
          '0': { selected: [], custom: 'DataTable' },
          '1': { selected: ['CSS Modules'] },
        });
      });
    });
