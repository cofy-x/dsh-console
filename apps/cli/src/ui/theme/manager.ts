...
import { AyuDark } from './presets/ayu.js';
import { AyuLight } from './presets/ayu-light.js';
import { AtomOneDark } from './presets/atom-one-dark.js';
import { Dracula } from './presets/dracula.js';
import { GitHubDark } from './presets/github-dark.js';
import { GitHubLight } from './presets/github-light.js';
import { GoogleCode } from './presets/googlecode.js';
import { Holiday } from './presets/holiday.js';
import { DefaultLight } from './presets/default-light.js';
import { DefaultDark } from './presets/default.js';
import { ShadesOfPurple } from './presets/shades-of-purple.js';
import { XCode } from './presets/xcode.js';
import * as fs from 'node:fs';
import * as path from 'node:path';
import type { Theme } from './core.js';
import { createCustomTheme, validateCustomTheme } from './core.js';
import type { SemanticColors } from './tokens.js';
import { ANSI } from './presets/ansi.js';
import { ANSILight } from './presets/ansi-light.js';
import { NoColorTheme } from './presets/no-color.js';
import process from 'node:process';
import { debugLogger, homedir } from '@cofy-x/dsh-console-core';
import type { CustomTheme, ThemeType } from './types.js';
