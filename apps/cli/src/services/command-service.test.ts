...
const mockCommandC = createMockCommand('command-c', CommandKind.DSH);
const mockCommandB_Override = createMockCommand('command-b', CommandKind.DSH);
...
describe('CommandService', () => {
  ...
  it('should override commands from earlier loaders with those from later loaders', async () => {
    ...
    expect(commandB?.kind).toBe(CommandKind.DSH); // Verify it's the overridden version.
  ...
  it('should handle user/project command override correctly', async () => {
    ...
    const userCommand = createMockCommand('help', CommandKind.DSH);
    const projectCommand = createMockCommand('deploy', CommandKind.DSH);
    const userDeployCommand = createMockCommand('deploy', CommandKind.DSH);
