...
describe('processing utils', () => {
  describe('getAsciiArtWidth', () => {
    it('measures visible terminal columns rather than ANSI bytes', () => {
      const art = '\u001b[38;2;77;107;254m██\u001b[39m\n█';

      expect(getAsciiArtWidth(art)).toBe(2);
    });

    it('uses the safe width fallback for unsupported Unicode', () => {
      expect(getAsciiArtWidth('؂')).toBe(1);
    });
  });
  ...
  describe('escapeAnsiCtrlCodes', () => {
    describe('escapeAnsiCtrlCodes string case study', () => {
      ...
      it('should handle nested objects and arrays', () => {
        ...
        expect(sanitized.b).toBeDefined();
        expect(sanitized.b).toBeInstanceOf(Object);
        ...
        expect(b.d[1]).toBeDefined();
        expect(b.d[1]).toBeInstanceOf(Object);
